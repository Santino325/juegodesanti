...
if(topObstaclesGroup.isTouching(balloon) || ballon.isTouching(topGround) || ballon.isTouching(bottomGround) || bottomObstaclesGroup.isTouching(balloon)){
  gameState = END;
  dieSound.play();
}
{
